  ...
  return (
    ...
    >
      ...
      <div className="form-input">
          ...
          <>
            {props.isIconInteractive && (
              <button
                ...
                tabIndex={props.isInteractiveIconAriaHidden ? -1 : undefined}
                ...
                className={
                  "icon interactive" +
                  (props.isInteractiveIconPrimary ? " primary" : "")
                }
              >
            ...
            {!props.isIconInteractive && (
              <BootstrapIcon
                ariaHidden={true}
                className="icon"
                icon={isValid ? props.icon : "exclamation-circle-fill"}
              />
            )}
          </>
        )}
        <input
          id={id}
          className={"form-input-element" + (props.isActive ? " focus" : "")}
          type={props.type}
      ...
      {props.links !== undefined && <div className="links">{props.links}</div>}
    </div>
  );
}
